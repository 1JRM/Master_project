...
bio1.vol <- biogas.vol[biogas.vol$id %in% c('CGP 01', 'HHW 01', 'CM 01', 'FG 01', 'Ino 01', 'Cell 01'), ]
bio2.vol <- biogas.vol[biogas.vol$id %in% c('CGP 02', 'HHW 02', 'CM 02', 'FG 02', 'Ino 02', 'Cell 02'), ]
bio3.vol <- biogas.vol[biogas.vol$id %in% c('CGP 03', 'HHW 03', 'CM 03', 'FG 03', 'Ino 03', 'Cell 03'), ]
...
# Add gc measurements from 01 to 02 and 03. These are NA right now.
  ...
  bio2.vol[bio2.vol$id %in% c('CGP 02', 'HHW 02', 'CM 02', 'FG 02', 'Ino 02', 'Cell 02'), 'xCH4_gc'] <- bio1.vol[bio1.vol$id %in% c('CGP 01', 'HHW 01', 'CM 01', 'FG 01', 'Ino 01', 'Cell 01'), 'xCH4_gc']

  bio3.vol[bio3.vol$id %in% c('CGP 03', 'HHW 03', 'CM 03', 'FG 03', 'Ino 03', 'Cell 03'), 'xCH4_gc'] <- bio1.vol[bio1.vol$id %in% c('CGP 01', 'HHW 01', 'CM 01', 'FG 01', 'Ino 01', 'Cell 01'), 'xCH4_gc']
